...
class FullCsvNoHeaderTest extends PHPUnit_Framework_TestCase {
	...
	function setUp() {
		$this->f = new CsvReader( dirname( dirname( __DIR__ ) ) . DIRECTORY_SEPARATOR . 'example' . DIRECTORY_SEPARATOR . 'example2.csv', array( 'header' => false ) );
		parent::setUp(); // TODO: Change the autogenerated stub
	}

	function testFgetcsvFunctions() {
		$lines = $this->f->fetchAll();

		$this->assertCount( 11, $lines );
		$this->assertTrue( $this->f->close() );
	}
